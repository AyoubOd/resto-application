    ...
    <div class="py-12 w-1/2 mx-auto">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form class="bg-gray-100 rounded-lg px-6 py-4"
                action="{{ route('admin.menus.update', ['menu' => $menu]) }}" method="POST"
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        required="required" name="name" value="{{ $menu->name }}">
                </div>
                <div class="mb-6">
                ...
                <button type="submit"
                    class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-blue-800">Update
                </button>
            </form>
