<x-admin-layout>
    ...
    <div class="py-12 w-1/2 mx-auto">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form class="bg-gray-100 rounded-lg px-6 py-4"
                action="{{ route('admin.reservation.update', ['reservation' => $reservation->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        value="{{ date_format(date_create($reservation->res_date), 'Y-m-d\TH:i:s') }}">
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <select name="table_id"
                        ...
                        @foreach ($tables as $table)
                            <option value="{{ $table->id }}" @selected($table->id == $reservation->table->id)>{{ $table->name }}
                                ({{ $table->guest }} Guests)
                            </option>
                        @endforeach
                    </select>
