 ...
 *   Build: 3f0aab53574b6e1d4ae1 - 3/5/2022
...
module.exports = {
  ...
  read_parameter_list: function read_parameter_list(is_class_constructor) {
    if (this.token != ")") {
      return this.read_list_with_dangling_comma(this.read_parameter.bind(this, is_class_constructor));
    }
  ...
  read_types: function read_types() {
    ...
    if (types.length === 1) {
      ...
      return isIntersection ? this.node("intersectiontype")(types) : this.node("uniontype")(types);
    }
  },
  ...
  read_type: function read_type() {
    ...
    } else if (this.token === this.tok.T_STRING || this.token === this.tok.T_STATIC) {
      var _type = this.text();
